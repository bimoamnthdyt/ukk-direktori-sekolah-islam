...
Route::post('media', 'MediaController@storeMedia')->name('webmedia.store');
...
Route::group([
    ...
    Route::get('schools/{id}/duplicate', 'SchoolController@duplicate')->name('schools.duplicate')->where('id', '[0-9]+');
