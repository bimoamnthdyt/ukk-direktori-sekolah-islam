<ul class="nav nav-tabs" id="custom-content-above-tab" role="tablist">
    <li class="nav-item">
    <a class="nav-link active" id="content-profile-tab" data-toggle="pill" href="#content-profile" role="tab" aria-controls="content-profile" aria-selected="true">Profile</a>
    </li>
    <li class="nav-item">
    <a class="nav-link" id="content-schools-tab" data-toggle="pill" href="#content-schools" role="tab" aria-controls="content-schools" aria-selected="false">{{ $user->getSchoolsCount() }} Schools</a>
    </li>
</ul>
<br/>
<div class="tab-content" id="custom-content-above-tabContent">
    <div class="tab-pane fade active show" id="content-profile" role="tabpanel" aria-labelledby="content-profile-tab">
    ...
    <div class="tab-pane fade" id="content-schools" role="tabpanel" aria-labelledby="content-schools-tab">
        <div class="card card-primary">
            <div class="card-body">
                @include('users.schoolTable')
            </div>
        </div>
    </div>
</div>
